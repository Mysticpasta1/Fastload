package com.mystic.quickboot.mixin.server;
...
import static com.mystic.quickboot.common.QBCommonEvents.Events.*;
import static com.mystic.quickboot.common.QBCommonEvents.Locations.PREPARE_START_REGION;
import static com.mystic.quickboot.common.QBCommonEvents.Locations.SERVER_TICK;
    ...
    private void handleProgressListener(ChunkProgressListener worldGenerationProgressListener, ChunkPos chunkPos) {
        if (PROGRESS_LISTENER_EVENT.isNotEmpty(PREPARE_START_REGION))
            PROGRESS_LISTENER_EVENT.execute(
                    new QBCommonEvents.Contexts.ProgressListenerContext(worldGenerationProgressListener, chunkPos)
            );
    }
}
