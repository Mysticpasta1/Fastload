package com.mystic.quickboot.api.event.def;

import com.mystic.quickboot.api.event.core.AbstractEvent;
import com.mystic.quickboot.api.event.core.EventArgs;
import com.mystic.quickboot.api.event.core.EventHolder;
import com.mystic.quickboot.api.event.core.EventStatus;
...
import static com.mystic.quickboot.api.event.core.EventStatus.*;

/**
 * An event class that provides all the necessary tools to create the exact event you need.
 * @param <Context> used for custom event params. Refer to {@link QBClientEvents FLClientEvents}
 *           for examples.
 */
